          ...
          <div class="card__content">
            ...
            <div class="card__additional">
              ...
              <div class="card__right">
                <div class="card__chips card__chips-pink">
                  Макс темп {{ item.main.temp_max }}
                </div>
                <div class="card__chips card__chips-blue">
                  Мин темп {{ item.main.temp_min }}
                </div>
              </div>
            </div>
            ...
            <div class="additional">
              <div class="additional__item">
                ...
                <div class="additional__text">
                  <span>Осадки</span><span>6%</span>
                </div>
              </div>
              <div class="additional__item">
                <img src="@/assets/img/humidity.svg" alt="" />
                <div class="additional__text">
                  <span>Влажность</span><span>{{ item.main.humidity }}%</span>
                </div>
              </div>
              <div class="additional__item">
                <img src="@/assets/img/wind.svg" alt="" />
                <div class="additional__text">
                  <span>Ветер</span><span>19 km/h</span>
                </div>
              </div>
            </div>
          </div>
